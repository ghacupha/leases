...
To build the final jar and optimize the leases application for production, run:
...
Then navigate to [http://localhost:22000](http://localhost:22000) in your browser.
