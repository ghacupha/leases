...
/**
 * Criteria class for the {@link io.github.leases.domain.LeasesMessageToken} entity. This class is used
 * in {@link io.github.leases.web.rest.LeasesMessageTokenResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /leases-message-tokens?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class LeasesMessageTokenCriteria implements Serializable, Criteria {
    ...
    public LeasesMessageTokenCriteria() {
    }

    public LeasesMessageTokenCriteria(LeasesMessageTokenCriteria other) {
    ...
    @Override
    public LeasesMessageTokenCriteria copy() {
        return new LeasesMessageTokenCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final LeasesMessageTokenCriteria that = (LeasesMessageTokenCriteria) o;
        return
    ...
    public String toString() {
        return "LeasesMessageTokenCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
