...
public interface IFileUploadResource {
     ...
     */
    ResponseEntity<LeasesFileUploadDTO> createFileUpload(@Valid @RequestBody LeasesFileUploadDTO fileUploadDTO) throws URISyntaxException;
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ResponseEntity<LeasesFileUploadDTO> updateFileUpload(@Valid @RequestBody LeasesFileUploadDTO fileUploadDTO) throws URISyntaxException;
     ...
     */
    ResponseEntity<List<LeasesFileUploadDTO>> getAllFileUploads(LeasesFileUploadCriteria criteria, Pageable pageable);
     ...
     */
    ResponseEntity<Long> countFileUploads(LeasesFileUploadCriteria criteria);
     ...
     */
    ResponseEntity<LeasesFileUploadDTO> getFileUpload(@PathVariable Long id);
