...
import { LeaseDetailsComponent } from 'app/entities/lease-details/lease-details.component';
...
describe('Component Tests', () => {
  describe('LeaseDetails Management Component', () => {
    let comp: LeaseDetailsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LeaseDetailsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.leaseDetails && comp.leaseDetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
