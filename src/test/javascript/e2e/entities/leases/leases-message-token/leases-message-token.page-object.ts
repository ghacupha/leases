...
export class LeasesMessageTokenComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-leases-message-token div table .btn-danger'));
  title = element.all(by.css('jhi-leases-message-token div h2#page-heading span')).first();
...
export class LeasesMessageTokenUpdatePage {
  pageTitle = element(by.id('jhi-leases-message-token-heading'));
...
export class LeasesMessageTokenDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-leasesMessageToken-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-leasesMessageToken'));
